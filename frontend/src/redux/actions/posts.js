...
export const getPosts = (page) => async (dispatch, getState) => {
   ...
   await axios
      .get(
         `http://localhost:8000/api/posts/feed-posts/?page=${page}`,
...
export const getProfilePosts = (page, username) => async (
   dispatch,
   getState
) => {
   if (!username) return;
   await axios
      .get(
         `http://localhost:8000/api/posts/listprofileposts/${username}/?page=${page}`,
         tokenConfig(getState)
      )
      .then((res) => {
         dispatch({
...
export const likeUnlikePost = (postSlug, like) => async (
   dispatch,
   getState
) => {
   var body;
   ...
   await axios
      .post(
         `http://localhost:8000/api/posts/like-unlike/${postSlug}/`,
         body,
         tokenConfig(getState)
      )
      .then((res) => {})
...
export const addPost = (post, username) => async (dispatch, getState) => {
   await axios
      .post(
         `http://localhost:8000/api/posts/listprofileposts/${username}/`,
         post,
         tokenConfig(getState)
      )
      .then((res) => {
...
export const getComments = (slug, page) => async (dispatch, getState) => {
   ...
   await axios
      .get(
         `http://localhost:8000/api/posts/listcomments/${slug}/?page=${page}`,
         tokenConfig(getState)
      )
      .then((res) => {
         dispatch({
...
export const getReplies = (id, page) => async (dispatch, getState) => {
   ...
   await axios
      .get(
         `http://localhost:8000/api/posts/listreplies/${id}/?page=${page}`,
         tokenConfig(getState)
      )
      .then((res) => {
         dispatch({
...
export const addComment = (comment, slug) => async (dispatch, getState) => {
   await axios
      .post(
         `http://localhost:8000/api/posts/createcomment/${slug}/`,
         comment,
         tokenConfig(getState)
      )
      .then((res) => {
...
export const handleBookmark = (slug) => async (dispatch, getState) => {
   ...
   await axios
      .post(
         `http://localhost:8000/api/posts/handlebookmarks/${slug}/`,
         body,
         tokenConfig(getState)
      )
      .then((res) => {})
...
export const getTrendingGifs = (key, limit, offset) => async (dispatch) => {
   await axios
      .get(
         `https://api.giphy.com/v1/gifs/trending?limit=${limit}&offset=${offset}&api_key=${key}`
      )
      .then((res) => {
         const previews = res.data.data.map((gif) => gif.images.preview);
         dispatch({
            type: "GET_GIFS",
            payload: previews,
         });
